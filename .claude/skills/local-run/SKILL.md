...
allowed-tools: Read, Grep, Glob, Bash(docker:*), Bash(docker compose:*), Bash(npm:*), Bash(npx:*), Bash(yarn:*), Bash(pnpm:*), Bash(go run:*), Bash(go build:*), Bash(python:*), Bash(uvicorn:*), Bash(curl:*), Bash(lsof:*), Bash(ss:*), Bash(nc:*), Bash(mongosh:*), Bash(ls:*), Bash(cat:*), Bash(env:*)
