...
3. If "Knowledge sharing" section has any non-empty items → note them in the retro doc. CLAUDE.md updates are reviewed in `/retro-sprint` (Step 5) — do not prompt here.
